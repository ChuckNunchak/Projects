    ...
    public class PageTagHelper:TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (PageViewModel.HasNextPage)
            {
                ...
                if (PageViewModel.PageNumber + 1 != PageViewModel.TotalPages)
                {
                    TagBuilder lastItem = CreateTag(PageViewModel.TotalPages, urlHelper);
                    tag.InnerHtml.AppendHtml("<li><a>...</a></li>");
